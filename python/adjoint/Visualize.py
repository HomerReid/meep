...
#from .ObjectiveFunction import (EHTransverse, Exyz, Hxyz,
#                                xhat, yhat, zhat, origin, abs2)
EHTransverse=[ [mp.Ey, mp.Ez, mp.Hy, mp.Hz],
               [mp.Ez, mp.Ex, mp.Hz, mp.Hx],
               [mp.Ex, mp.Ey, mp.Hx, mp.Hy] ]

##################################################
# old (pre-DFTCell) utility routines for working
# with DFT objects; probably delete
##################################################
